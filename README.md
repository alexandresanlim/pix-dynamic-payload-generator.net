...
Este pacote é a implementação em .net para auxiliar na geração de payloads e QRCodes dinâmicos para pagamento PIX, seguindo os padrões e contratos do [pix-api](https://github.com/bacen/pix-api).
